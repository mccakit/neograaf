...
export namespace graaf::utils::fixtures {
 ...
 */
template <typename T> class my_weighted_edge : public weighted_edge<T> {
public:
 ...
 */
template <typename T> class my_unit_weighted_edge {};
 ...
 */
template <typename T> struct my_unweighted_edge {
  using weight_t = T;
  T val{};
};
